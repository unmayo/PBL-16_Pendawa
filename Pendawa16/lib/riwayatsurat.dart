      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          riwayatList = dataList.map((item) {
            ...
            String imagePath =
                titleImagePathMap[item['jenis_surat']] ?? 'images/default.png';

            return {
              'nik': item['no_ktp'],
              'imagePath': imagePath, // Replace with the actual image path
              'title':
                  item['jenis_surat'], // Add the title field from your data
              'time': item['tgl_upload'], // Add the time field from your data
              'content':
                  item['nama_lengkap'], // Add the content field from your data
              'deskripsi':
                  item['deskripsi'], // Add the deskripsi field from your data
              'status': item['status'], // Add the status field from your data
